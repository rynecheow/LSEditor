...
public class SVGColorScheme extends Color {
    ...
    private static enum SVGColorKeyword {
        ...
        CORAL(255, 127, 80), CORNFLOWERBLUE(100, 149, 237), CORNSILK(255, 248, 220), CIRMSON(220, 20, 60),
        CYAN(0, 255, 255), DAKRBLUE(0, 0, 139), DARKCYAN(0, 139, 139), DAKRGOLDENROD(184, 134, 11),
        ...
        DAKRSLATEGRAY(47, 79, 79), DARKSLATEGREY(47, 79, 79), DARKTURQUOSE(0, 206, 209), DARKVIOLET(148, 0, 211),
        ...
        GOLDENROD(218, 165, 32), GRAY(128, 128, 128), GREY(128, 128, 128), GREEN(0, 128, 0), GREENYELLOW(173, 255, 47),
        ...
        LIGHTCYAN(224, 255, 255), LIGHTGOLDENYELLOW(250, 250, 210), LIGHTGRAY(211, 211, 211),
        LIGHTGREEN(144, 238, 144), LIGHTGREY(211, 211, 211), LIGHTPINK(255, 182, 193), LIGHTSALMON(255, 160, 122),
        LIGHTSEAGREEN(32, 178, 170), LIGHSKYBLUE(135, 206, 250), LIGHTSLATEGRAY(119, 136, 153),
        ...
        MEDIUMSPRINGGREEN(0, 250, 154), MEDIUMTURQUOISE(72, 209, 204), MEDIUMVIOLETERED(199, 21, 133),
        ...
        PALEVIOLETERED(219, 112, 147), PAPAYAWHIP(255, 239, 213), PEACHPUFF(255, 218, 185), PERU(205, 133, 63),
        PINK(255, 192, 203), PLUM(221, 160, 221), POWDERBLUE(176, 224, 230), PURPLE(128, 0, 128), RED(255, 0, 0),
