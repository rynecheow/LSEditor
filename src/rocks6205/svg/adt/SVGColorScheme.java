...
public class SVGColorScheme extends Color {
    ...
    private static enum SVGColorKeyword {
        ...
        ALICEBLUE(240, 248, 255), ANTIQUEWHITE(250, 235, 215), AQUA(0, 255, 255), AQUAMARINE(127, 255, 212),
                                  ...
                                  CORNFLOWERBLUE(100, 149, 237), CORNSILK(255, 248, 220), CIRMSON(220, 20, 60),
                                  CYAN(0, 255, 255), DAKRBLUE(0, 0, 139), DARKCYAN(0, 139, 139),
                                  DAKRGOLDENROD(184, 134, 11), DARKGRAY(169, 169, 169), DARKGREEN(0, 100, 0),
                                  ...
                                  DARKSLATEBLUE(72, 61, 139), DAKRSLATEGRAY(47, 79, 79), DARKSLATEGREY(47, 79, 79),
                                  DARKTURQUOSE(0, 206, 209), DARKVIOLET(148, 0, 211), DEEPPINK(255, 20, 147),
                                  ...
                                  LIGHTGOLDENYELLOW(250, 250, 210), LIGHTGRAY(211, 211, 211),
                                  LIGHTGREEN(144, 238, 144), LIGHTGREY(211, 211, 211), LIGHTPINK(255, 182, 193),
                                  LIGHTSALMON(255, 160, 122), LIGHTSEAGREEN(32, 178, 170), LIGHSKYBLUE(135, 206, 250),
                                  ...
                                  MEDIUMVIOLETERED(199, 21, 133), MIDNIGHTBLUE(25, 25, 112), MINTCREAM(245, 255, 250),
                                  ...
                                  PALEVIOLETERED(219, 112, 147), PAPAYAWHIP(255, 239, 213), PEACHPUFF(255, 218, 185),
